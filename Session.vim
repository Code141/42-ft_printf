...
badd +1 includes/s_printf_flags.h
argglobal
silent! argdel *
argadd Makefile
set stal=2
...
wincmd w
argglobal
edit includes/s_printf_flags.h
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 67 - ((21 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 73 - ((43 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((18 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
