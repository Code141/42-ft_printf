...
badd +18 srcs/specifiers/spec_d.c
...
exe '2resize ' . ((&lines * 57 + 41) / 83)
exe 'vert 2resize ' . ((&columns * 84 + 182) / 364)
exe '3resize ' . ((&lines * 6 + 41) / 83)
exe 'vert 3resize ' . ((&columns * 84 + 182) / 364)
exe '4resize ' . ((&lines * 72 + 41) / 83)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((24 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
47
normal! zo
let s:l = 71 - ((64 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((33 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 73 - ((69 * winheight(0) + 39) / 79)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
wincmd w
argglobal
edit ~/cursus/ft_printf/srcs/interceptor.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((45 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
wincmd w
argglobal
edit ~/cursus/ft_printf/includes/s_ctx.h
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 44 - ((30 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((24 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
exe 'vert 6resize ' . ((&columns * 84 + 182) / 364)
exe 'vert 7resize ' . ((&columns * 109 + 182) / 364)
tabedit ~/cursus/ft_printf/includes/buff_writer.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 19 + 41) / 83)
exe 'vert 1resize ' . ((&columns * 84 + 182) / 364)
exe '2resize ' . ((&lines * 19 + 41) / 83)
exe 'vert 2resize ' . ((&columns * 84 + 182) / 364)
...
wincmd w
argglobal
edit ~/cursus/ft_printf/srcs/buff_writer.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((10 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
...
wincmd w
argglobal
edit ~/cursus/ft_printf/srcs/specifiers/spec_u.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
edit ~/cursus/ft_printf/srcs/specifiers/spec_x.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((22 * winheight(0) + 39) / 79)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
wincmd w
argglobal
edit ~/cursus/ft_printf/srcs/specifiers/spec_o.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 79 - ((77 * winheight(0) + 39) / 79)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
